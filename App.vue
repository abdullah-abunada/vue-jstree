<template>
  <div id="app" style="padding-bottom: 300px;">
    ...
    <div>
      <div style="width:840px; margin: 0 auto;">
        <div style="width:49%; display:inline-block; vertical-align: top;">
          <p style="text-align:right">Search Text <input type="text" @keyup="inputKeyUp" v-model="searchText"/></p>
          <br>
          <v-jstree :data="data"
        ...
        <textarea style="height:300px; width:100%; direction: ltr">
          {{data}}
        </textarea>
        </div>
      </div>
    ...
    <div>
      <div style="width:840px; margin: 0 auto;">
        <div style="width:49%; display:inline-block; vertical-align: top;">
          <v-jstree :data="asyncData" :async="loadData" size="large"
                    show-checkbox multiple allow-batch whole-row @item-click="itemClick" ref="tree2"></v-jstree>
        </div>
            ...
            <template slot-scope="_">
              <div style="display: inherit; width: 200px" @click.ctrl="customItemClickWithCtrl">
                ...
                <button style="border: 0px; background-color: transparent; cursor: pointer;"
                        @click="customItemClick(_.vm, _.model, $event)"><i class="fa fa-remove"></i></button>
              </div>
            </template>
          </v-jstree>
        </div>
